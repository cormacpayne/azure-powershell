#
# Module manifest for module 'PSGet_Az.Kusto'
#
...
CmdletsToExport = 'New-AzKustoCluster', 'Get-AzKustoCluster', 'Remove-AzKustoCluster', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Capacity is a new and optional parameter for Create and Update Cluster.
